function Footer() {
    return (<footer class="bg-[black] text-white rounded-t-[5%] mt-[100px]">
        ...
        <div className="f5 w-[80%] flex justify-center items-center m-[auto] h-[80px]">
            <p class="text-[#fff] text-[25px] uppercase">Creat By Agravat Hiren</p>
        </div>
    </footer>)
}
